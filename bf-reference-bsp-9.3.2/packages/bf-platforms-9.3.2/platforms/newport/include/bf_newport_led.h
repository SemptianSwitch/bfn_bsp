...
#ifndef _BF_NEWPORT_LED_H
#define _BF_NEWPORT_LED_H
...
#define BF_NEWPORT_PORT_LED_OFF 0x0
#define BF_NEWPORT_PORT_LED_RED 0x4
#define BF_NEWPORT_PORT_LED_GREEN 0x2
#define BF_NEWPORT_PORT_LED_BLUE 0x1
#define BF_NEWPORT_PORT_LED_BLINK 0x8
