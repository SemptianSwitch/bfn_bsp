/*******************************************************************************
 * Bopyright (c) 2015-2020 Barefoot Networks, Inc.
...
bf_status_t newport_diag_service_port_status_show(bf_dev_id_t dev_id,
...
bf_status_t newport_diag_service_fec(bf_dev_id_t dev_id, int port, char *fec);
...
bf_status_t newport_diag_service_prbs_set(bf_dev_id_t dev_id,
                                          int port,
                                          uint32_t p_value);
bf_status_t newport_diag_service_prbs_clean(bf_dev_id_t dev_id, int front_port);
